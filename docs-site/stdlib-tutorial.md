...
You should be familiar with Arc basics — see the [Getting Started Guide](/getting-started) and [Language Tour](/language-tour) first.
...
- Check the [Standard Library Reference](/stdlib-reference) for full API details
- Browse [examples](https://github.com/kai-builds-ai/arc-lang/tree/main/examples) for complete programs
- Read the [Language Tour](/language-tour) for all language features
