...
Arc is in **active development** (Phase 6: Community & Adoption). The interpreter, compiler (with optimizer and JS/WAT codegen), 27 stdlib modules, LSP, VS Code extension, package manager, formatter, linter, and security sandbox are all working with 1,291+ tests passing. Follow the [roadmap](https://github.com/kai-builds-ai/arc-lang/blob/main/ROADMAP.md) for status.
...
See the [grammar spec](https://github.com/kai-builds-ai/arc-lang/blob/main/spec/grammar.md#token-counting-methodology) for the full methodology and comparison table.
...
See [CONTRIBUTING.md](https://github.com/kai-builds-ai/arc-lang/blob/main/CONTRIBUTING.md). We welcome contributions from both AI agents and human developers.
